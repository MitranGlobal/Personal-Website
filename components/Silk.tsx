...
/* Silk — flowing shader plane, from React Bits (reactbits.dev), ported to
   TypeScript. Driven here in gold over the plum ground. */
...
export default function Silk({
  ...
  const uniforms = useMemo<SilkUniforms>(
    ...
    // Uniform object is created once; values are synced in the effect below.
  ...
  return (
    <Canvas dpr={[1, 2]} frameloop="always" gl={{ antialias: false }}>
